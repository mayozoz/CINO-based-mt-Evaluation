...
def main(src_file, *tgt_files):
    """
    usage:
    python3 CINO/CINO_ranking_comparative.py tbt-cn-200/src_clean.txt tbt-cn-200/mt-hyps/hyp_deepseek-v3 tbt-cn-200/mt-hyps/hyp_google-translate tbt-cn-200/mt-hyps/hyp_qwen2.5_72b
    """
    # Load data
    ...
    output_dir = "tbt-cn-200/CINO_mev_scores"
